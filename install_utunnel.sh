...
case $ARCH in
    "x86_64")
        URL="https://github.com/AmirMSH/utunnel/blob/main/utunnel_manager_amd64"
        ;;
    "aarch64" | "arm64")
        URL="https://github.com/AmirMSH/utunnel/blob/main/utunnel_manager_arm64"
        ;;
    "i386" | "i686")
        URL="https://github.com/AmirMSH/utunnel/blob/main/utunnel_manager_386"
        ;;
    *)
